...
**JavaScript**: dynamische functionaliteiten worden afgehandeld door JavaScript, een programmeertaal die door alle browsers wordt ondersteund. Er is geen beperking op welk framework of bibliotheek er wordt gebruikt. Het hoeft zelfs geen Javascript te zijn. Programmeertalen als Ruby, Python en Go worden ook gebruikt.
